...
train_pipeline = [
    dict(type='SampleFrames', clip_len=48, frame_interval=2, num_clips=1),
...
workflow = [('train', 1)]
evaluation = dict(
    interval=1, metrics=['mean_average_precision', 'multi_class_AUC'])
log_config = dict(
    interval=20,
    hooks=[
...
log_level = 'INFO'
work_dir = './work_dirs/lma_predict/slowfast_lma'
# load_from = 'model_zoo_dirs/slowfast_r101_8x8x1_256e_kinetics400_rgb_20210218-0dd54025.pth'
load_from = None
resume_from = None
